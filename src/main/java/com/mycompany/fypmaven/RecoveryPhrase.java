...
//        Copy Recovery Code Action Listener
//      Changes the text of the copy code button on click
...
//      Copy Recovery Code Focus Listener
//      Changes the text of the Copy Code button on focus lost
...
// Function to generate a unique recovery code 
...
//    This is the copy button code block
...
//    This code block is responsible to redirecting the user back to the the initial login page 
...
//        Generates an Encryption Key
        try {
            ...
            EncryptKey = new String(secretKey.getEncoded(), StandardCharsets.UTF_8);
...
//      Declaring the variables
        Object[] Accdata = {Username, HashedPassword, TxtRecovery.getText(), EncryptKey};
        String insertQuery = "INSERT INTO user_accounts (Name, Password, Recovery_Phrase,Secret_Key) VALUES (?,?,?,?)";

        //        Inserting the user account into the system
        try {

            logger.info("Inserting the user account into the system");
            ...
            logger.info("Successfully inserted the user account into the system");
            
        } catch (SQLException ex) {
            logger.error(ex.getMessage());
        }

//      Redirects the user back to the login panel
        this.dispose();
