...
//              Checks if there are records with the submitted recovery phrase
                String recovery = connection.executeReadQuery(query,param,"Recovery_Phrase");
                
//                Checks if the record exist
                if(recovery.isEmpty()){
                    
//                  Gets the information of the user and creates the object
                    String password = connection.executeReadQuery(query,param,"Password");
                    String username = connection.executeReadQuery(query,param,"Name");
                    UserAccs user = new UserAccs(username,password);
                    
//                  Directs the user to the reset password frame 
                    ResetPassword resetPassword = new ResetPassword(user);
                    resetPassword.setVisible(true);
                    this.dispose();
                    
                }else{
//                    Notifies the user that the phrase entered was incorrect
